...
router.post(
  "/:id/phases/:phaseId/sub-steps",
  authorizeProjectAccess,
  updateSubStep,
);
router.post(
  "/:id/phases/:phaseId/questions/:questionId/answer",
  authorizeProjectAccess,
  answerQuestion,
);
router.post(
...
router.post(
  "/:id/phases/:phaseId/attachments",
  authorizeProjectAccess,
  upload.single("file"),
  uploadAttachment,
);
router.post(
  "/:id/phases/:phaseId/attachments/signed-urls",
  authorizeProjectAccess,
  getAttachmentSignedUrls,
);
router.delete(
  "/:id/phases/:phaseId/attachments/:attachmentId",
  authorizeProjectAccess,
  deleteAttachment,
);
router.patch(
...
router.post(
  "/:id/phases/:phaseId/sub-steps/:subStepId/attachments",
  authorizeProjectAccess,
  upload.single("file"),
  uploadSubStepAttachment,
);
router.delete(
  "/:id/phases/:phaseId/sub-steps/:subStepId/attachments/:attachmentId",
  authorizeProjectAccess,
  deleteSubStepAttachment,
);
router.patch(
