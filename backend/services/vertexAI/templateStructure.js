    ...
    sections: [
      {
        id: "hero",
        instruction:
          'Hero: __IMAGE_1__ as banner (background or full-width img), dark overlay, "{businessName}", tagline, CTA. py-24.',
      },
      {
        id: "features",
        instruction:
          '"Why Choose Us": 3-6 feature cards in md:grid-cols-3. Emoji/SVG icon, title, description. Hover shadow.',
      },
      {
        id: "stats",
        instruction:
          '3-4 stat counters in a row (e.g. "500+ Projects", "98% Satisfaction"). bg-gray-50.',
      },
      {
        id: "testimonials",
        instruction:
          '"What Our Clients Say": 3 cards with avatar (__IMAGE_2__/__IMAGE_3__), name, role, stars, quote. Grid.',
      },
      {
        id: "cta",
        instruction:
          "Gradient section: headline, subtitle, action button. py-16.",
      },
    ],
  },
  about: {
    ...
    sections: [
      {
        id: "pageHeader",
        instruction: 'Gradient banner: "About {businessName}", subtitle.',
      },
      {
        id: "companyStory",
        instruction:
          "Two-column md:grid-cols-2: text (history, mission) left, __IMAGE_2__ right.",
      },
      {
        id: "team",
        instruction:
          "3-4 team cards: avatar (__IMAGE_2__/__IMAGE_3__), name, role. Rounded-full, hover shadow.",
      },
      {
        id: "statsMilestones",
        instruction: "Stats or milestones timeline. bg-gray-50.",
      },
      {
        id: "gallery",
        instruction: "4-6 images grid (__IMAGE_1__/2/3). Hover overlay.",
      },
    ],
  },
  services: {
    ...
    sections: [
      {
        id: "pageHeader",
        instruction: 'Banner: "Our Services" title and subtitle.',
      },
      {
        id: "servicesGrid",
        instruction:
          '4-6 service cards: emoji/SVG icon, title, description, "Learn More". md:grid-cols-2 lg:grid-cols-3.',
      },
      {
        id: "process",
        instruction:
          '"How We Work": 3-4 numbered steps, flex row. Number circle, title, description.',
      },
      {
        id: "faq",
        instruction:
          "4-6 accordion questions with useState toggle. Expand/collapse.",
      },
    ],
  },
  contact: {
    ...
    sections: [
      {
        id: "pageHeader",
        instruction: 'Banner: "Contact Us" title and subtitle.',
      },
      {
        id: "contactInfoCards",
        instruction:
          "3 cards: Email, Phone, Location. Emoji icons. bg-gray-50.",
      },
      {
        id: "contactForm",
        instruction:
          "Form: Name, Email, Subject, Message. Submit button. Focus rings.",
      },
      {
        id: "newsletter",
        instruction:
          'Email signup strip: "Stay Updated", input, subscribe button.',
      },
    ],
  },
};
    ...
    sections: [
      {
        id: "hero",
        instruction:
          'Hero: __IMAGE_1__ banner, dark overlay, "{businessName}", tagline, "Shop Now". py-24.',
      },
      {
        id: "promoBar",
        instruction:
          "Announcement strip: free shipping, discount, or sale. Contrasting bg.",
      },
      {
        id: "featuredProducts",
        instruction:
          '"Trending Now": 3-4 product cards with badge, image (__IMAGE_1__/2/3), name, price, "Add to Cart".',
      },
      {
        id: "categories",
        instruction:
          "4-6 category cards: bg image (__IMAGE_1__/2/3), dark overlay, name in white. Hover zoom.",
      },
      {
        id: "testimonials",
        instruction:
          "3 review cards: avatar (__IMAGE_2__/3), name, stars, quote. bg-gray-50.",
      },
      {
        id: "newsletter",
        instruction:
          "Email input, subscribe button, persuasive text. Gradient bg.",
      },
    ],
  },
  about: {
    ...
    sections: [
      {
        id: "pageHeader",
        instruction: 'Banner: "About {businessName}", subtitle.',
      },
      {
        id: "companyStory",
        instruction:
          "Two-column: text (history, mission) left, __IMAGE_2__ right.",
      },
      {
        id: "stats",
        instruction:
          '3-4 stats ("1000+ Products", "50k+ Customers", etc.). bg-gray-50.',
      },
      {
        id: "team",
        instruction: "3-4 team cards: avatar (__IMAGE_2__/3), name, role.",
      },
      {
        id: "cta",
        instruction: 'Gradient: "Start Shopping Today" headline and button.',
      },
    ],
  },
  products: {
    ...
    sections: [
      ...
      {
        id: "filterBar",
        instruction: "Category filter buttons/tabs. Pill-style.",
      },
      {
        id: "productGrid",
        instruction:
          '6-12 product cards: image (__IMAGE_1__/2/3), name, description, price, "Add to Cart". Grid responsive.',
      },
      {
        id: "cta",
        instruction: '"Can\'t find what you need? Contact us" with button.',
      },
    ],
  },
  contact: {
    ...
    sections: [
      ...
      {
        id: "contactInfoCards",
        instruction: "3 cards: Email, Phone, Address. Emoji icons. bg-gray-50.",
      },
      {
        id: "contactForm",
        instruction:
      ...
      {
        id: "faq",
        instruction: "4-6 accordion questions with useState toggle.",
      },
    ],
  },
  login: {
    ...
    sections: [
      {
        id: "authForm",
        instruction: `Login form: Centered card, logo (__LOGO__), Email + Password inputs (optional defaultValue for demo), Submit button. NO validation or credential logic — form onSubmit: e.preventDefault(); onNavigate(e, 'dashboard'). "Forgot password?" link (visual only). "Register" link: onClick={(e)=>onNavigate(e,'register')}. Sharp corners (rounded-none), Tailwind only.`,
      },
    ],
  },
  register: {
    ...
    sections: [
      {
        id: "authForm",
        instruction: `Register form: Centered card, logo (__LOGO__), Name + Email + Password inputs, Submit button. NO validation — form onSubmit just calls onNavigate(e, 'login'). "Already have an account? Login" with button onClick to setCurrentPage('login'). Sharp corners (rounded-none), focus rings, Tailwind only.`,
      },
    ],
  },
};
...
export const MANAGEMENT_PAGES = {
  login: {
    ...
    sections: [
      {
        id: "authForm",
        instruction: `Centered card (max-w-md mx-auto), logo (__LOGO__), Email + Password inputs. form onSubmit: e.preventDefault(); onNavigate(e, 'dashboard'). "Register" link: onClick onNavigate(e, 'register'). rounded-none.`,
      },
    ],
  },
  register: {
    ...
    sections: [
      {
        id: "authForm",
        instruction: `Centered card, logo (__LOGO__), Name + Email + Password. form onSubmit: e.preventDefault(); onNavigate(e, 'login'). "Login" link. rounded-none.`,
      },
    ],
  },
  dashboard: {
    ...
    sections: [
      {
        id: "statsOverview",
        instruction:
          "EXACTLY 4 stat cards in grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4. Each: label (text-sm text-gray-500) + value (text-2xl font-bold). Labels/values CONTEXTUAL to domain. No other content.",
      },
    ],
  },
  products: {
    ...
    sections: [
      {
        id: "productTable",
        instruction:
          "Title (h2) then ONE table: thead + tbody with .map. Columns contextual (e.g. Name, Type, Status). 4-6 mock rows, domain-specific data. Wrap table in bg-white overflow-x-auto.",
      },
    ],
  },
  users: {
    ...
    sections: [
      {
        id: "userTable",
        instruction:
          "Title (h2) then ONE table: thead + tbody with .map. Columns: Name, Role/Dept, Status. 4-6 mock rows, domain-specific. Wrap in bg-white overflow-x-auto.",
      },
    ],
  },
};
